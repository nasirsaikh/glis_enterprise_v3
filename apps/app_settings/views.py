...
from .models import HeroSection, Page, Service, ServiceCategory, Statistic, Testimonial, ThemeSettings
...
def portal_page_detail(request, slug):
    filters = {"slug": slug, "is_visible": True, "state": Page.State.PUBLISHED, "publication_date__lte": timezone.now(), "audience__in": [Page.Audience.PORTAL, Page.Audience.BOTH]}
    try:
