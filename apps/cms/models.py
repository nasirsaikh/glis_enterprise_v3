...
class NavigationItem(TimeStampedModel, LocalizedModelMixin):
    ...
    allowed_groups = models.ManyToManyField("auth.Group", related_name="cms_navigation_items", blank=True)
...
class Page(TimeStampedModel, LocalizedModelMixin):
    ...
    allowed_groups = models.ManyToManyField("auth.Group", related_name="cms_pages", blank=True)
